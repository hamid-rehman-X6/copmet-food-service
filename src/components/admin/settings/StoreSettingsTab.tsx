...
// Store currency + delivery pricing. Changing the currency only affects display.
export function StoreSettingsTab() {
  ...
  if (!form) {
    return <p className="rounded-xl border border-error/30 bg-error/5 px-5 py-4 text-sm text-error">{error}</p>;
  }
