...
export const dashboardMetrics: AdminMetric[] = [
  ...
  { label: "Menu Items", value: "48", change: "42 active", detail: "across 6 categories", icon: "utensils", tone: "neutral" },
];

export const menuMetrics: AdminMetric[] = [
  { label: "Total Items", value: "48", detail: "Across all categories", icon: "utensils", tone: "primary" },
  { label: "Active", value: "42", detail: "Currently available", icon: "check", tone: "success" },
  { label: "Out of Stock", value: "4", detail: "Needs attention", icon: "minus", tone: "danger" },
  { label: "Drafts", value: "2", detail: "Awaiting review", icon: "book", tone: "warning" },
];
...
export const orderMetrics: AdminMetric[] = [
  ...
  { label: "Preparing", value: "18", detail: "In the kitchen", icon: "utensils", tone: "warning" },
  { label: "On the Way", value: "12", detail: "Out for delivery", icon: "truck", tone: "success" },
...
export const adminDishes: AdminDish[] = [
  {
    ...
    detail: "Vegan, Nut-Free",
    category: "Bowls",
    price: 15.5,
    status: "Active",
    image: { src: "/images/menu/harvest-bowl-img.png", alt: "Mediterranean grain bowl." },
  },
  {
    id: "dish-02",
    name: "Rustic Slow-Roasted Beef",
    detail: "Chef's Special",
    category: "Main Course",
    price: 24,
    status: "Active",
    image: { src: "/images/home-page/beaf-steak-img.png", alt: "Slow-roasted beef." },
  },
  {
    id: "dish-03",
    ...
    price: 10,
    status: "Inactive",
    image: { src: "/images/home-page/choco-strawberry-cake.png", alt: "Dark chocolate torte." },
  },
  {
    id: "dish-04",
    ...
    price: 18,
    status: "Out of Stock",
    image: { src: "/images/menu/wild-salmon-img.png", alt: "Wild salmon poke bowl." },
  },
  {
    id: "dish-05",
    ...
    price: 6.5,
    status: "Draft",
    image: { src: "/images/menu/mint-sparkler-img.png", alt: "Hibiscus mint sparkler." },
  },
];
...
export const adminOrders: AdminOrder[] = [
  { id: "ORD-82910", customer: "Sophia Carter", items: 3, total: 52.5, placed: "Today, 10:24 AM", status: "Preparing" },
  { id: "ORD-82909", customer: "James Wilson", items: 2, total: 38, placed: "Today, 9:48 AM", status: "On the Way" },
