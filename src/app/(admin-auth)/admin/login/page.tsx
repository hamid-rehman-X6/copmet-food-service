...
export const metadata: Metadata = {
  ...
  description: "Sign in to the Copmet Food Service frozen operations admin panel.",
};
...
export default function AdminLoginPage() {
  return (
    <div>
      ...
      <p className="mt-3 max-w-sm text-sm leading-6 text-muted-foreground">Frozen operations access for Copmet Food Service.</p>
